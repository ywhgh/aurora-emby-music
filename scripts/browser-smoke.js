...
function checkPageState(check, page) {
  ...
  if (!isMobileImmersiveLayoutCheck) {
    ...
    assert(desktopImmersiveLayout.before?.playButtonLoadingAnimationName === "playbackLoadingArc", `${label} desktop immersive play loading should use the reference-style rotating arc: ${JSON.stringify(desktopImmersiveLayout.before)}`);
    ...
    assert(desktopImmersiveLayout.before?.playButtonLoadingBackgroundImage === "none", `${label} desktop immersive play loading should use a clean border arc: ${JSON.stringify(desktopImmersiveLayout.before)}`);
    ...
    assert(desktopImmersiveLayout.before?.playButtonLoadingMaskImage === "none", `${label} desktop immersive play loading should not use the old gradient mask: ${JSON.stringify(desktopImmersiveLayout.before)}`);
    assert(desktopImmersiveLayout.before?.playButtonLoadingTransform !== "none", `${label} desktop immersive play loading arc should rotate: ${JSON.stringify(desktopImmersiveLayout.before)}`);
  ...
  if (isMobileImmersiveLayoutCheck) {
    ...
    assert(mobileImmersiveLayout.before?.playButtonLoadingAnimationName === "playbackLoadingArc", `${label} mobile immersive play loading should use the reference-style rotating arc: ${JSON.stringify(mobileImmersiveLayout.before)}`);
    ...
    assert(mobileImmersiveLayout.before?.playButtonLoadingBackgroundImage === "none", `${label} mobile immersive play loading should use a clean border arc: ${JSON.stringify(mobileImmersiveLayout.before)}`);
    ...
    assert(mobileImmersiveLayout.before?.playButtonLoadingMaskImage === "none", `${label} mobile immersive play loading should not use the old gradient mask: ${JSON.stringify(mobileImmersiveLayout.before)}`);
    assert(mobileImmersiveLayout.before?.playButtonLoadingTransform !== "none", `${label} mobile immersive play loading arc should rotate: ${JSON.stringify(mobileImmersiveLayout.before)}`);
