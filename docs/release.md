...
```powershell
gh release create v0.92.90 --title "v0.92.90" --notes-file RELEASE_NOTES.md
```
...
4. Select tag `v0.92.90`.
5. Use `v0.92.90` as the title.
