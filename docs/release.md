...
```powershell
gh release create v0.92.84 --title "v0.92.84" --notes-file RELEASE_NOTES.md
```
...
4. Select tag `v0.92.84`.
5. Use `v0.92.84` as the title.
