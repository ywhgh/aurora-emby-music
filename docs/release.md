...
```powershell
gh release create v0.92.94 --title "v0.92.94" --notes-file RELEASE_NOTES.md
```
...
4. Select tag `v0.92.94`.
5. Use `v0.92.94` as the title.
