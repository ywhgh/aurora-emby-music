...
```powershell
gh release create v0.92.87 --title "v0.92.87" --notes-file RELEASE_NOTES.md
```
...
4. Select tag `v0.92.87`.
5. Use `v0.92.87` as the title.
