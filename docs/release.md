...
```powershell
gh release create v0.92.91 --title "v0.92.91" --notes-file RELEASE_NOTES.md
```
...
4. Select tag `v0.92.91`.
5. Use `v0.92.91` as the title.
