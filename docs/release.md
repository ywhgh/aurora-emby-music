...
```powershell
gh release create v0.92.89 --title "v0.92.89" --notes-file RELEASE_NOTES.md
```
...
4. Select tag `v0.92.89`.
5. Use `v0.92.89` as the title.
