...
```powershell
gh release create v0.92.86 --title "v0.92.86" --notes-file RELEASE_NOTES.md
```
...
4. Select tag `v0.92.86`.
5. Use `v0.92.86` as the title.
