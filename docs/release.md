...
```powershell
gh release create v0.92.88 --title "v0.92.88" --notes-file RELEASE_NOTES.md
```
...
4. Select tag `v0.92.88`.
5. Use `v0.92.88` as the title.
